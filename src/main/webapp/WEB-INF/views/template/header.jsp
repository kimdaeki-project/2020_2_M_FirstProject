        ...
        <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="slide" src="./resources/img/fc_16.jpg" alt="First slide">
                    
                </div>
                <div class="carousel-item">
                    <img class="slide" src="./resources/img/fc_main.png" alt="Second slide">
                    <div class="container">
                        
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="slide" src="./resources/img/fc_slide.jpg" alt="Third slide">
